 ...
 */
final class Version20240228105433 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP categories');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD categories LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\'');
    }
}
